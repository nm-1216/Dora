...
namespace Dora.Weixin.Helpers
{
    ...
    {
        /// <summary>
        /// 获取缓存Key（命名空间，形如：Container:Dora.Weixin.MP.Containers.AccessTokenBag）
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// 获取ContainerBag缓存Key，包含命名空间（形如：Container:Dora.Weixin.MP.Containers.AccessTokenBag:wx669ef95216eef885）
        /// </summary>
