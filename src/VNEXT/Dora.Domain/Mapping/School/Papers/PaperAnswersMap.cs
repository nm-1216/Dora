namespace Dora.Domain.Mapping.School
{
    ...
    public class PaperAnswersMap : EntityBaseConfiguration<PaperAnswers>
    {
        public override void ConfigureDerived(EntityTypeBuilder<PaperAnswers> builder)
        {
            ///Primary Key
            builder.HasKey(b => new { b.PaperAnswerId });
            ...
            builder.ToTable("School_PaperAnswers");
