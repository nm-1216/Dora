namespace Dora.Domain.Mapping.School
{
    ...
    public class SyllabusLogMap : EntityBaseConfiguration<SyllabusLog>
    {
        public override void ConfigureDerived(EntityTypeBuilder<SyllabusLog> builder)
        {
            ///Primary Key
            builder.HasKey(b => new { b.SyllabusLogId });
            ...
            builder.ToTable("School_SyllabusLog");
