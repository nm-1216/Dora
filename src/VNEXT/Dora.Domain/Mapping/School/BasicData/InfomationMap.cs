namespace Dora.Domain.Mapping.School
{
    ...
    public class InfomationMap : EntityBaseConfiguration<Infomation>
    {
        public override void ConfigureDerived(EntityTypeBuilder<Infomation> builder)
        {
            ///Primary Key
            builder.HasKey(b => new { b.InfomationId });
            ...
            builder.ToTable("School_Infomations");
