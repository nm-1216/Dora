...
namespace Dora.Weixin.MP.AdvancedAPIs.MerChant
{
    /// <summary>
    /// 微小店商品接口
    /// </summary>
    public static class ProductApi
    {
        ...
        public static async Task<AddProductResult> AddProductAsync(string accessToken, AddProductData addProductData)
        {
            ...
            return await Dora.Weixin.CommonAPIs.CommonJsonSend.SendAsync<AddProductResult>(accessToken, urlFormat, addProductData);
        }
        ...
        public static async Task<WxJsonResult> UpDateProductAsync(string accessToken, UpdateProductData reviseProduct)
        {
            ...
            return await Dora.Weixin.CommonAPIs.CommonJsonSend.SendAsync<WxJsonResult>(accessToken, urlFormat, reviseProduct);
        }
        ...
        public static async Task<GetProductResult> GetProductAsync(string accessToken, string productId)
        {
            ...
            return await Dora.Weixin.CommonAPIs.CommonJsonSend.SendAsync<GetProductResult>(accessToken, urlFormat, data);
        }
        ...
        public static async Task<GetByStatusResult> GetByStatusAsync(string accessToken, int status)
        {
            ...
            return await Dora.Weixin.CommonAPIs.CommonJsonSend.SendAsync<GetByStatusResult>(accessToken, urlFormat, data);
        }
        ...
        public static async Task<GetSubResult> GetSubAsync(string accessToken, long cateId)
        {
            ...
            return await Dora.Weixin.CommonAPIs.CommonJsonSend.SendAsync<GetSubResult>(accessToken, urlFormat, date);
        }
        ...
        public static async Task<GetSkuResult> GetSkuAsync(string accessToken, long cateId)
        {
            ...
            return await Dora.Weixin.CommonAPIs.CommonJsonSend.SendAsync<GetSkuResult>(accessToken, urlFormat, data);
        }
        ...
        public static async Task<GetPropertyResult> GetPropertyAsync(string accessToken, long cateId)
        {
            ...
            return await Dora.Weixin.CommonAPIs.CommonJsonSend.SendAsync<GetPropertyResult>(accessToken, urlFormat, data);
        }
        #endregion
#endif
    }
