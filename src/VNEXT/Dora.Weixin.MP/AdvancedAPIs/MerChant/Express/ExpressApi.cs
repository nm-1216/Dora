...
namespace Dora.Weixin.MP.AdvancedAPIs
{
    ...
    public static class ExpressApi
    {
        ...
        public static async Task<AddExpressResult> AddExpressAsync(string accessToken, AddExpressData addExpressData)
        {
            ...
            return await Dora.Weixin.CommonAPIs.CommonJsonSend.SendAsync<AddExpressResult>(accessToken, urlFormat, addExpressData);
        }
        ...
        public static async Task<WxJsonResult> UpDateExpressAsync(string accessToken, UpDateExpressData upDateExpressData)
        {
            ...
            return await Dora.Weixin.CommonAPIs.CommonJsonSend.SendAsync<WxJsonResult>(accessToken, urlFormat, upDateExpressData);
        }
        ...
        public static async Task<GetByIdExpressResult> GetByIdExpressAsync(string accessToken, int templateId)
        {
            ...
            return await Dora.Weixin.CommonAPIs.CommonJsonSend.SendAsync<GetByIdExpressResult>(accessToken, urlFormat, data);
        }
        ...
        public static async Task<GetAllExpressResult> GetAllExpressAsync(string accessToken)
        {
            ...
            return await Dora.Weixin.CommonAPIs.CommonJsonSend.SendAsync<GetAllExpressResult>(accessToken, urlFormat, null, CommonJsonSendType.GET);
        }
        #endregion
#endif
    }
