...
namespace Dora.Weixin.MP.AdvancedAPIs.MerChant
{
    ...
    public static class StockApi
    {
        ...
        public static async Task<WxJsonResult> AddStockAsync(string accessToken, AddStockData addStockData)
        {
            ...
            return await Dora.Weixin.CommonAPIs.CommonJsonSend.SendAsync<WxJsonResult>(accessToken, urlFormat, addStockData);
        }
        ...
        public static async Task<WxJsonResult> ReduceStockAsync(string accessToken, ReduceStockData reduceStockData)
        {
            ...
            return await Dora.Weixin.CommonAPIs.CommonJsonSend.SendAsync<WxJsonResult>(accessToken, urlFormat, reduceStockData);
        }
        #endregion
#endif
    }
