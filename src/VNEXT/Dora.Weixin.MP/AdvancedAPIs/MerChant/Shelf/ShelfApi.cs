...
namespace Dora.Weixin.MP.AdvancedAPIs.MerChant
{
    ...
    public static class ShelfApi
    {
        ...
        public static async Task<AddShelfResult> AddShelvesAsync(string accessToken, M1 m1, M2 m2, M3 m3, M4 m4, M5 m5, string shelfBanner, string shelfName)
        {
            ...
            return await Dora.Weixin.CommonAPIs.CommonJsonSend.SendAsync<AddShelfResult>(accessToken, urlFormat, data);
        }
        ...
        public static async Task<GetAllShelfResult> GetAllShelvesAsync(string accessToken)
        {
            ...
            return await Dora.Weixin.CommonAPIs.CommonJsonSend.SendAsync<GetAllShelfResult>(accessToken, urlFormat, null, CommonJsonSendType.GET);
        }
        ...
        public static async Task<GetByIdShelfResult> GetByIdShelvesAsync(string accessToken, int shelfId)
        {
            ...
            return await Dora.Weixin.CommonAPIs.CommonJsonSend.SendAsync<GetByIdShelfResult>(accessToken, urlFormat, data);
        }
        #endregion
#endif
    }
