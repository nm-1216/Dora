...
namespace Dora.Weixin.MP.TenPayLibV3
{
    ...
    public static partial class TenPayV3
    {
        ...
        {
            return string.Format(urlFormat, Dora.Weixin.Config.UseSandBoxPay ? "sandboxnew/" : "");
        }
        ...
        //退款申请请可参考Dora.Weixin.MP.Sample中的退款demo
        /// <summary>
        /// 退款申请接口
        /// </summary>
        /// <param name="dataInfo"></param>
        ...
        //退款申请请直接参考Dora.Weixin.MP.Sample中的退款demo
        ///// <summary>
        ///// 退款申请接口
        ///// </summary>
        ///// <param name="data"></param>
        ...
        //    ms.Write(formDataBytes, 0, formDataBytes.Length);
        //    ms.Seek(0, SeekOrigin.Begin);//设置指针读取位置
        //    return Dora.Weixin.HttpUtility.RequestUtility.HttpPost(urlFormat, null, ms);
        //}
